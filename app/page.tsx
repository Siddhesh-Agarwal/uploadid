                    ...
                    <div className="mt-6 text-center md:ml-6 flex flex-row justify-center">
                        <SignedOut>
                            <SignUpButton mode="modal">
                                <Button variant={"outline"} className="bg-foreground px-4 py-2 text-background mx-1">
                                    Register
                                </Button>
                            </SignUpButton>
                        </SignedOut>
                        ...
                        <Link href={"/pricing"}>
                            <Button variant={"outline"} className="bg-background px-4 py-2 text-foreground mx-1">
                                View Pricing
                            </Button>
                        </Link>
                    </div>
